...
public record AsyncTryResult<TValue, TError>
	...
	/// <summary>
	/// If this <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see> represents a success, returns a value, otherwise returns <see langword="null"/>.<br/>
	...
	/// <summary>
	/// If this <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see> represents an error, returns the error, otherwise returns <see langword="null"/>.<br/>
	...
	/// <summary>
	/// Indicates if this <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see> represents a success.<br/>
	...
	/// <summary>
	/// Indicates if this <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see> represents an error.<br/>
	...
	/// <summary>
	/// Initializes a new <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see> record that represents a success.
	/// </summary>
	/// <param name="value">The value to be stored by the <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see>.</param>
	...
	/// <summary>
	/// Initializes a new <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see> record that represents an error.
	/// </summary>
	/// <param name="error">The error to be stored by the <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see>.</param>
	...
	/// <summary>
	/// Implicit conversion from an <see langword="object"/> of type <typeparamref name="TValue"/> to an <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see> representing a success.
	/// </summary>
	/// <param name="value">The value to be stored by the <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see>.</param>
	...
	/// <summary>
	/// Implicit conversion from an <see langword="object"/> of type <typeparamref name="TError"/> to an <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see> representing an error.
	/// </summary>
	/// <param name="error">The error to be stored by the <see cref="AsyncTryResult&lt;TValue, TError&gt;">AsyncTryResult</see>.</param>
